...
- Hybrid cars : Cars powered by both electric and fossil fuels.
...
The chart above shows the 3 most fuel-efficient car of 3 fuel types: Electric, Hybird and Gas in 2019 [(1)](#1).

The Mitsubishi Mirage consumes 6 L/100km - 3.5 times higher than the Tesla Model 3 which consumes 1.7 L/100km.

Even with the hybrid Toyora Prius which are very popular in the US consumes 4.2 L/100kma, still __2.5__ times higher than Tesla Model 3.
...
At the end of this section, we will find energy efficiency rate ($$\eta_{e}$$) of Combustion Engine and Electric Cars.

<div style="overflow:auto">
<figure style="width:30%; float:left; margin-right:10px">
    <img src="/assets/img/posts/energy_efficiency.png" />
    <figcaption style='text-align:center; font-size:13px; color:gray;'>Energy efficiency</figcaption>
</figure>
This rate reflect how effective the cars use input energy, for example if $$\eta_{e} = 80\%$$It means 80% of the input energy(in the form of gas/electric) has been converted to kinetic energy that put our car to move, 20% has been converted to other form of energy that are not helpful to us like heat.
</div>

The way we find this rate is to find where are the energy wasted?
- Energy conversion
- Power to wheels
- Auxiliary systems
